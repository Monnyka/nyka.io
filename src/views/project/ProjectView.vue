<template>
    <div>
    <div class=" relative bg-gradient-to-r from-green-500 to-green-400 rounded-md mx-auto container flex flex-col items-start mt-6 p-8 justify-center h-[175px]">
    <p class="text-3xl font-black text-white">Daily project manager</p>
    <router-link to="/createproject" class="bg-[#f9f9f9] p-2 rounded-full font-bold font-white px-6 mt-2">Create New Project</router-link>
    </div>
    </div>

  <div class="relative mx-auto mt-8 px-8 container grid grid-cols-4 gap-10">
